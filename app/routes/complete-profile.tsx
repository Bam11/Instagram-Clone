...
// Predefined avatars
const AVATARS = [
  { id: 1, name: "Avatar 1", src: "/images/daniel.jpg" },
  { id: 2, name: "Avatar 2", src: "/images/_vibe_with.jpg" },
  { id: 3, name: "Avatar 3", src: "/images/wicker.jpg" },
  { id: 4, name: "Avatar 4", src: "/images/post.jpg" },
];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.imageFile) {
        ...
        const {
          data: { publicUrl },
        } = supabase.storage.from("user-profile-image").getPublicUrl(filePath);
